...
description: 'Learn how bring a analytical rigour to our decisions and subjective opinions '
seo:
  image:
    src: '/images/dec-A5NT.png'
tags:
  - Decision Making
  - Mental Models
...
![](/images/thought-process--1--g0Nz.png)
...
A simpler approach would be to list the attributes you want to assess, assign weights to them, and then score each candidate on a scale of 10. Finally, the candidate with the highest score is hired (assuming they are withinwithinbudget). This approach allows for a more analytical rigour to your intuitions
